' customproductsboxes.co.uk Secure Email Setup.vbs
'
...
' *************************************************************************
strIncServerAddress	   = "customproductsboxes.co.uk"		 					' This is the address for the mail server
strOutServerAddress	   = "customproductsboxes.co.uk"		 					' This is the address for the mail server
