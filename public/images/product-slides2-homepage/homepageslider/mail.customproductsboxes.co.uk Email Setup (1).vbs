' mail.customproductsboxes.co.uk Email Setup.vbs
'
...
' *************************************************************************
strIncServerAddress	   = "mail.customproductsboxes.co.uk"		 					' This is the address for the mail server
strOutServerAddress	   = "mail.customproductsboxes.co.uk"		 					' This is the address for the mail server
strServerMailPort 	   = "0000006e"							' The port on the server to which to connect
																' Imap:  Secure = 000003e1  Unsecure = 0000008f
																' Pop:   Secure = 000003e3	Unsecure = 0000006e
strAccount			   = "nancy@customproductsboxes.co.uk"							' Mail account to connect as
strSecureConnection    = "00000000"					' Use a secure connection - 00000001 for true, 00000000 for false
...
strServerSmtpPort	   = "0000024b"							' Smtp port on the server
